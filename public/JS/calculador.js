...
function calculatePrice(value, basePrice) {
...
async function loadData() {
    try {
        console.log('🔄 Cargando datos directamente desde la API externa...');
        
        // Cargar directamente desde dataracing.com.ar
        const r = await fetch('https://dataracing.com.ar/wp-content/uploads/cars_data.json');
        ...
        console.log(`✅ ${allCars.length} autos cargados exitosamente`);
        ...
        if (loadingEl) {
            loadingEl.innerHTML = `
                <div style="color:#dc3545;padding:20px;text-align:center;">
                    ...
                    <button onclick="loadData()" style="margin-top:10px;padding:8px 16px;background:#007bff;color:white;border:none;border-radius:4px;cursor:pointer;">
                        Reintentar
                    </button>
                </div>
            `;
